...
\begin{figure}[h]
    \centering
    \includegraphics[trim={0 1.5in 5.3in 0},clip,width=0.8\columnwidth]{icra_fig_1}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\columnwidth]{overview_hz}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{flowgraph}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\linewidth]{classifier}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{rollouts}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\columnwidth]{armresults}
...
\begin{figure*}[h]
    \centering
    \includegraphics[height=1.63in,keepaspectratio]{simple_hook}\hfill
    \includegraphics[height=1.63in,keepaspectratio]{multi_hook}\hfill
    \includegraphics[height=1.63in,keepaspectratio]{complex_hook}\hfill
    \includegraphics[height=1.63in,keepaspectratio]{engine_assembly}%
